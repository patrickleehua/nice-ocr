...
- [ ] 2.5 Add an optional provider model import API endpoint that fetches `/v1/models`-compatible responses, upserts models idempotently, and leaves catalogs unchanged on failure.
...
- [ ] 4.4 Show import success and failure states without discarding unsaved provider edits or blocking manual model management.
- [ ] 4.5 Verify the settings UI on desktop and mobile viewports.

## 5. Tests and Documentation

- [ ] 5.1 Add unit tests for model endpoint derivation and optional import response parsing/failure behavior.
...
- [ ] 5.4 Update README provider configuration notes to describe provider-owned models and optional `/v1/models` import behavior.
